...
class WebhookBot:
    ...
    async def setup(self):
        ...
        self.application.add_handler(CallbackQueryHandler(wager_callback, pattern=r'^wager_(yes|no)_'))
...
async def main():
    ...
    if not webhook_url:
        ...
        if render_service_url:
            ...
            # Fallback - construct from service name (adjust as needed)
            service_name = os.getenv('RENDER_SERVICE_NAME', 'marbitz-battlebot')
